...
impl ScreenshotManager {
    ...
    pub fn do_screenshot(&self, area: &mut gdk::Rectangle, filename: &str, include_cursor: bool) -> bool {
        unsafe {
            from_glib(ffi::phosh_screenshot_manager_do_screenshot(self.to_glib_none().0, area.to_glib_none_mut().0, filename.to_glib_none().0, include_cursor.into_glib()))
        }
    }
}
