...
extern "C" {
    ...
    pub fn phosh_screenshot_manager_do_screenshot(self_: *mut PhoshScreenshotManager, area: *mut gdk::GdkRectangle, filename: *const c_char, include_cursor: gboolean) -> gboolean;
