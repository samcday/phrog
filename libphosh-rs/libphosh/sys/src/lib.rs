...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct PhoshDragSurfaceClass {
    pub parent_class: PhoshLayerSurfaceClass,
    pub dragged: Option<unsafe extern "C" fn(*mut PhoshDragSurface, c_int)>,
}

impl ::std::fmt::Debug for PhoshDragSurfaceClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PhoshDragSurfaceClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct PhoshTopPanelClass {
    pub parent_class: PhoshDragSurfaceClass,
}

impl ::std::fmt::Debug for PhoshTopPanelClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PhoshTopPanelClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct PhoshDragSurface {
    pub parent_instance: PhoshLayerSurface,
}

impl ::std::fmt::Debug for PhoshDragSurface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PhoshDragSurface @ {self:p}"))
...
#[repr(C)]
pub struct PhoshKeypad {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

impl ::std::fmt::Debug for PhoshKeypad {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PhoshKeypad @ {self:p}"))
         .finish()
    }
}
...
#[repr(C)]
pub struct PhoshTopPanel {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

impl ::std::fmt::Debug for PhoshTopPanel {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PhoshTopPanel @ {self:p}"))
         .finish()
    }
}
...
extern "C" {
    ...
    pub fn phosh_drag_surface_get_drag_handle(self_: *mut PhoshDragSurface) -> c_uint;
    pub fn phosh_drag_surface_get_drag_mode(self_: *mut PhoshDragSurface) -> PhoshDragSurfaceDragMode;
    pub fn phosh_drag_surface_get_drag_state(self_: *mut PhoshDragSurface) -> PhoshDragSurfaceState;
    pub fn phosh_drag_surface_get_threshold(self_: *mut PhoshDragSurface) -> c_float;
    pub fn phosh_drag_surface_set_drag_handle(self_: *mut PhoshDragSurface, handle: c_uint);
    pub fn phosh_drag_surface_set_drag_mode(self_: *mut PhoshDragSurface, mode: PhoshDragSurfaceDragMode);
    pub fn phosh_drag_surface_set_drag_state(self_: *mut PhoshDragSurface, state: PhoshDragSurfaceState);
    pub fn phosh_drag_surface_set_exclusive(self_: *mut PhoshDragSurface, exclusive: c_uint);
    pub fn phosh_drag_surface_set_margin(self_: *mut PhoshDragSurface, margin_folded: c_int, margin_unfolded: c_int);
    pub fn phosh_drag_surface_set_threshold(self_: *mut PhoshDragSurface, threshold: c_double);
    ...
    pub fn phosh_keypad_distribute(self_: *mut PhoshKeypad);
    pub fn phosh_keypad_get_end_action(self_: *mut PhoshKeypad) -> *mut gtk::GtkWidget;
    pub fn phosh_keypad_get_entry(self_: *mut PhoshKeypad) -> *mut gtk::GtkEntry;
    pub fn phosh_keypad_get_shuffle(self_: *mut PhoshKeypad) -> gboolean;
    pub fn phosh_keypad_get_start_action(self_: *mut PhoshKeypad) -> *mut gtk::GtkWidget;
    pub fn phosh_keypad_set_end_action(self_: *mut PhoshKeypad, end_action: *mut gtk::GtkWidget);
    pub fn phosh_keypad_set_entry(self_: *mut PhoshKeypad, entry: *mut gtk::GtkEntry);
    pub fn phosh_keypad_set_shuffle(self_: *mut PhoshKeypad, shuffle: gboolean);
    pub fn phosh_keypad_set_start_action(self_: *mut PhoshKeypad, start_action: *mut gtk::GtkWidget);
    ...
    pub fn phosh_shell_get_top_panel(self_: *mut PhoshShell) -> *mut PhoshTopPanel;
    ...
    pub fn phosh_top_panel_fold(self_: *mut PhoshTopPanel);
    pub fn phosh_top_panel_get_state(self_: *mut PhoshTopPanel) -> PhoshTopPanelState;
    pub fn phosh_top_panel_toggle_fold(self_: *mut PhoshTopPanel);
    pub fn phosh_top_panel_unfold(self_: *mut PhoshTopPanel);
    ...
    pub fn phosh_register_resource();
    ...
    pub fn phosh_uninit();
    pub fn phosh_unregister_resource();
