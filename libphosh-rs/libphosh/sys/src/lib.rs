...
// Enums
pub type PhoshLayerSurfaceLayer = c_int;
pub const PHOSH_LAYER_SURFACE_LAYER_BACKGROUND: PhoshLayerSurfaceLayer = 0;
pub const PHOSH_LAYER_SURFACE_LAYER_BOTTOM: PhoshLayerSurfaceLayer = 1;
pub const PHOSH_LAYER_SURFACE_LAYER_TOP: PhoshLayerSurfaceLayer = 2;
pub const PHOSH_LAYER_SURFACE_LAYER_OVERLAY: PhoshLayerSurfaceLayer = 3;
...
// Flags
pub type PhoshLayerSurfaceAnchor = c_uint;
pub const PHOSH_LAYER_SURFACE_ANCHOR_NONE: PhoshLayerSurfaceAnchor = 0;
pub const PHOSH_LAYER_SURFACE_ANCHOR_TOP: PhoshLayerSurfaceAnchor = 1;
pub const PHOSH_LAYER_SURFACE_ANCHOR_BOTTOM: PhoshLayerSurfaceAnchor = 2;
pub const PHOSH_LAYER_SURFACE_ANCHOR_LEFT: PhoshLayerSurfaceAnchor = 4;
pub const PHOSH_LAYER_SURFACE_ANCHOR_RIGHT: PhoshLayerSurfaceAnchor = 8;
...
extern "C" {
    ...
    pub fn phosh_layer_surface_set_child(self_: *mut PhoshLayerSurface, child: *mut gtk::GtkWidget);
