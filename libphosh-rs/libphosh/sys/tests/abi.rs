...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    ("PhoshDragSurface", Layout {size: size_of::<PhoshDragSurface>(), alignment: align_of::<PhoshDragSurface>()}),
    ("PhoshDragSurfaceClass", Layout {size: size_of::<PhoshDragSurfaceClass>(), alignment: align_of::<PhoshDragSurfaceClass>()}),
    ...
    ("PhoshTopPanelClass", Layout {size: size_of::<PhoshTopPanelClass>(), alignment: align_of::<PhoshTopPanelClass>()}),
