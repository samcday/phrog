...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ("(guint) PHOSH_LAYER_SURFACE_ANCHOR_BOTTOM", "2"),
    ("(guint) PHOSH_LAYER_SURFACE_ANCHOR_LEFT", "4"),
    ("(guint) PHOSH_LAYER_SURFACE_ANCHOR_NONE", "0"),
    ("(guint) PHOSH_LAYER_SURFACE_ANCHOR_RIGHT", "8"),
    ("(guint) PHOSH_LAYER_SURFACE_ANCHOR_TOP", "1"),
    ("(gint) PHOSH_LAYER_SURFACE_LAYER_BACKGROUND", "0"),
    ("(gint) PHOSH_LAYER_SURFACE_LAYER_BOTTOM", "1"),
    ("(gint) PHOSH_LAYER_SURFACE_LAYER_OVERLAY", "3"),
    ("(gint) PHOSH_LAYER_SURFACE_LAYER_TOP", "2"),
